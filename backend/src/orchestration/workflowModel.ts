...
export type ExecutionLifecycleState = 'waiting_approval' | 'approved' | 'claimed' | 'running' | 'completed' | 'failed' | 'blocked';
...
export interface WorkflowState {
  ...
  executionLifecycle: Partial<Record<AgentName, AgentExecutionLifecycle>>;
